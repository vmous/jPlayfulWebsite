...
public class Account extends Controller {
	...
	public static Result verifyEmail() {
		com.feth.play.module.pa.controllers.Authenticate.noCache(response());
		final User user = Application.getCurrentUser(session());
		if (user.emailValidated) {
			...
			flash(Application.FLASH_MESSAGE_KEY, Messages.get(
					...
					user.email));
			PlayfulUsernamePasswordAuthProvider.getProvider()
	...
	public static Result changePassword() {
		com.feth.play.module.pa.controllers.Authenticate.noCache(response());
		final User u = Application.getCurrentUser(session());
	...
	public static Result doChangePassword() {
		...
		if (filledForm.hasErrors()) {
			...
			user.changePassword(new PlayfulUsernamePasswordAuthUser(newPassword),
					true);
			flash(Application.FLASH_MESSAGE_KEY,
