...
create table users_linked_account (
  users_id                       bigint not null,
  linked_account_id              bigint not null,
  constraint pk_users_linked_account primary key (users_id, linked_account_id))
;
...
alter table users_linked_account add constraint fk_users_linked_account_users_01 foreign key (users_id) references users (id) on delete restrict on update restrict;

alter table users_linked_account add constraint fk_users_linked_account_linke_02 foreign key (linked_account_id) references linked_account (id) on delete restrict on update restrict;
...
drop table if exists users_linked_account;
